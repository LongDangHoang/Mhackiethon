 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        O = function (t) {
          ...
          for (e = 0; e < A.length; e++)
            if ((n = A[e] + i) in j.style) return { dom: n, css: M[e] + t };
        },
        F = (e.support = {
      ...
      var q = (e.frame = (function () {
        ...
        C = l(function (e) {
          ...
          (e.init = function (e) {
            ...
            F.backface &&
              H.hideBackface &&
              X(this.el, F.backface.css, "hidden");
          }),
            b("add", r),
            b("start", o),
            b("wait", function (t) {
            ...
            b("stop", s),
            b("set", function (t) {
              s.call(this, t), d.call(this, t, v, g);
            }),
            b("show", function (t) {
              ...
              H.fallback || i.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    ("ease" != this.ease ? z + f[this.ease][0] : "") +
        ...
        N = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (q(n), e = L(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      (e.fallback = function (t) {
        if (!F.transition) return (H.fallback = !0);
        H.agentTests.push("(" + t + ")");
  ...
  function (t, e, n) {
    n(4), n(7), n(8), n(9), n(10), (t.exports = n(11));
  },
  function (t, e, n) {
    "use strict";
    var i = n(0);
        ...
        function p(e) {
          ...
          if (
            ...
            var c,
              f =
                ((c = a),
                d.test(c.hash) && c.host + c.pathname === n.host + n.pathname
                  ? a.hash
                  : "");
            if ("" !== f) {
              var h = t(f);
      ...
      (t.exports = function (t, e) {
        ...
        function y(e, n) {
          ...
          (r.handler = null),
            ...
            g.test(s) ? (r.handler = E) : s || (o ? (r.handler = S) : b());
        }
        function x(t) {
        ...
        return (
          (c.ready = c.design = c.preview = function () {
            !(function () {
              ...
              if (
                ((u = "".concat(s, "/signFile")), !(n = t(d + " form")).length)
              )
                return;
              n.each(y);
            })(),
              w ||
                ...
                (function () {
                  ...
                  l.on(
                    "change",
                    d + ' form input[type="checkbox"]:not(.w-checkbox-input)',
                    function (e) {
                      t(e.target)
                    ...
                    e.forEach(function (e) {
                      ...
                      l.on(
                        "focus",
                        d + ' form input[type="'.concat(r, '"]:not(') + o + ")",
                        function (e) {
                          t(e.target)
                            .siblings(o)
